					...
					<div class="row">
						<div style="padding-right: 40px" class="col-xs-12 col-md-8">
							...
							<div class="form-group">
								<div class="col-sm-12">
									<input type="text" class="col-xs-12 col-sm-12" name="nama_barang" placeholder="Nama Barang.." autocomplete="off" required />
								</div>
							</div>
				...
				<form class="form-horizontal" role="form" action="modules/barang/proses.php?act=update" method="POST" enctype="multipart/form-data" />
					...
					<div class="row">
						<div style="padding-right: 40px" class="col-xs-12 col-md-8">
							...
							<div class="form-group">
								<div class="col-sm-12">
									<input type="text" class="col-xs-12 col-sm-12" name="nama_barang" placeholder="Nama Barang.." autocomplete="off" value="<?php echo $nama_barang; ?>" required />
								</div>
							</div>
