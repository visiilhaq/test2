						...
						<table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            ...
                            ?>
                            	<tr>
									...
									<td width="80" class="center"><?php echo $data2['jumlah']; ?></td>
									...
									<td width="80" class="center">
										<div class="action-buttons">
											...
											<a data-rel="tooltip" data-placement="top" title="Hapus" class="red tooltip-error" href="modules/kategori/proses.php?act=delete&id=<?php echo $data['id_kategori'];?>" onclick="return confirm('Anda yakin ingin menghapus kategori barang <?php echo $data['nama_kategori']; ?> ?');">
