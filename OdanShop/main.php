...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Pengembangan Aplikasi Web E-Commerce pada ONESHOP Bandar Lampung">
        <meta name="author" content="ONESHOP Bandar Lampung">

        <title>Odan Shop</title>
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="?page=home">
                        <img src="assets/img/logo3.png" width="135">
                    </a>
                </div>
    ...
    ?>
        ...
        <footer style="margin-bottom:0">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <p>Copyright &copy; 2016 - <a href="?module=home">Odan Shop</a></p>
                    </div>
                </div>
            </div>
        </footer>
