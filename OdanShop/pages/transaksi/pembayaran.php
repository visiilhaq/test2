            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="alert alert-success alert-dismissible" role="alert">
                        ...
                        Silahkan lakukan pembayaran ke salah satu rekening kami. Setelah itu lakukan konfirmasi pembayaran melalui menu <strong>Konfirmasi Pembayaran</strong>.
                    </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <strong>BCA</strong> - Cabang Bandar Lampung <br>
                                            Nomor rekening: <strong>178 303 7878</strong> <br>
                                            Atas Nama: <strong>Toko Oneshop</strong>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <strong>BNI</strong> - Cabang Bandar Lampung <br>
                                            Nomor rekening: <strong>800 600 6009</strong> <br>
                                            Atas Nama: <strong>Toko Oneshop</strong>
                                        </div>
                                    </div>
                                </div>
