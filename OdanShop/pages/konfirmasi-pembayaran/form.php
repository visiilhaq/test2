                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal" method="POST" action="pages/konfirmasi-pembayaran/proses.php" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" id="jumlah_pembayaran" name="jumlah_pembayaran" autocomplete="off" onKeyPress="return goodchars(event,'0123456789',this)" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input style="margin-top:2px;height:35px" type="file" name="gambar" required>
                                        </div>
                                    </div>
